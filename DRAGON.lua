...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝚂𝙾𝚄𝚁𝙲𝙴 𝚆𝙾𝙻𝙵")  
...
send(msg.chat_id_, msg.id_,' 🕸 تم تحديث السورس \n 🕸 لديك اخر اصدار لسورس وُلَف\n 🕸 الاصدار ⤶ { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🕸 اصدار سورس وُلَف \n 🕸 الاصدار ⤶{ v 1.5}')
end
...
🇮🇹Benvenuto nella fonte del lupo🇮🇹
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟𝕃𝕌ℂ𝕀𝔽𝔼ℝ🇮🇹｠⌯',url="t.me/LLucifeerr"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟DEV 𝕃𝕌ℂ𝕀𝔽𝔼ℝ✶🇮🇹｠⌯',url="t.me/LLucifeerr"}},
{{text = '⌯｟DEV 7𝐑𝐁𝐎𝐊𝐀✶🇮🇹｠⌯',url="t.me/de_vi_d"}},
{{text = '⌯｟TＷＡＳＯＬ✶🇮🇹｠⌯',url="t.me/gejdkdk_bot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع حظر لوسيفر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1223908266) then  
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع حظر صاحب السورس حربوكا عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🕸 لا يمكنك حظر صاحب السورس حربي \n")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع حظر صاحب السورس حربي عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1409176813) then  
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع كتم المبرمج لوسيفر ")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1223908266) then  
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع كتم صاحب السورس حربي")
return false 
end
...
if result.id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " 🕸 لا يمكنك كتم لوسيفر \n")
return false 
end
if result.id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " 🕸 لا يمكنك كتم صاحب السورس حربي \n")
return false 
end
usertext = '\n 🕸 العضو ⤶ ['..result.title_..'](t.me/'..(username or 'DV_POWER1')..')'
status  = '\n 🕸 تم كتمه عام من الجروبات'
...
if tonumber(userid) == tonumber(1409176813) then  
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع كتم لوسيفر عام")
return false 
end
if tonumber(userid) == tonumber(1223908266) then  
send(msg.chat_id_, msg.id_, " 🕸 لا تسطيع كتم صاحب السورس حربي عام")
return false 
end
...
send(msg.chat_id_, msg.id_," 🕸 عذرا الملف لايدعم سورس وُلَف \n") 
end
return false
end
...
-----------------------------------------------------
if text == 'مسح الزباب' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🕸 تم تنزيل جميع الزباب بالجروب')
end
if text == ("تاك للزباب") and Mod(msg) then
...
---------
if text == ("رفع زب") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل زب")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' 🕸  الايدي بالصوره ⤶ { '..idph..
' }\n'..' 🕸  الرفع ⤶ { '..setadd..
' }\n'..' 🕸  الحظر ⤶ { '..banm..' }\n\n≪━━━━━━𝙒𝙊𝙇𝙁 𓃠 ━━━━━━≫\n 🕸 قناة سورس وُلَف ↓\n [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝚆𝙾𝙻𝙵](t.me/s_o_u_r_c_e_w_ol_f) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝚆𝙾𝙻𝙵.',url="t.me/s_o_u_r_c_e_w_ol_f"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/s_o_u_r_c_e_w_ol_f)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[هتسبني...لمين🥺💗](t.me/s_o_u_r_c_e_w_ol_f)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[كمر..اسود🌚](t.me/s_o_u_r_c_e_w_ol_f)')
return false
end
end
end
